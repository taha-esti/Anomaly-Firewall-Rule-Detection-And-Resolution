...
def write_anomalies_to_csv(path: str, anomalies, delimiter: str = ","):
    ...
    headers = [
        ...
        "Rule A Source Zone",
        "Rule B Source Zone",
        "Rule A Destination Zone",
        "Rule B Destination Zone",
        "Rule A Source Network",
        "Rule B Source Network",
        "Rule A Destination Network",
        "Rule B Destination Network",
        "Rule A Source Port",
        "Rule B Source Port",
        "Rule A Destination Port",
        "Rule B Destination Port",
        "Rule A Application Filter",
        "Rule B Application Filter",
    ]
